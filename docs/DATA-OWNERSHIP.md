...
| Cross-project lessons, durable personal knowledge | no standing provider — the obsidian-mind/om trial closed (docs/DECISIONS.md D028); synthesized deliberately by a human, or by a narrow skill when a concrete need emerges | not a durable store | none |
...
| --- | --- | --- |
| Accepted project decision | `docs/DECISIONS.md` when repo-scoped; an explicitly chosen durable owner when genuinely personal or cross-repo | projectmem alone, chat, auto-memory |
